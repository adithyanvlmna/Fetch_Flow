...
class _CommonTextFieldState extends State<CommonTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    final outlineTextInputBorder = OutlineInputBorder(
    ...
    return TextFormField(
      ...
      style: widget.isStyle == true
          ? TextStyle(
              fontWeight: FontWeight.bold,
              color: Colors.black,
              fontSize: widget.isHalf == true && widget.controller.text.length > 20 ? 10 : 14,
            )
          : TextStyle(
              color: Colors.black,
              fontSize: widget.isHalf == true && widget.controller.text.length > 20 ? 10 : 14,
      ...
      inputFormatters: widget.isFormatter == true
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: widget.prefixIcon != null
            ? Icon(widget.prefixIcon, color: _focusNode.hasFocus ? Colors.black : Colors.grey)
            : null,
